...
@section('content')
    <div class="space-y-6">
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            <p class="text-gray-600 text-sm">Manage your products, stock levels, and pricing</p>
                    ...
                    <tbody class="divide-y divide-gray-200">
                        @forelse($products as $product)
                            <tr class="hover:bg-gray-50 transition">
                                ...
                                <td class="px-6 py-4 font-semibold text-[#D7B259]">${{ number_format($product->price, 2) }}
                                </td>
                                <td class="px-6 py-4">
                                    <span
                                ...
                                <td class="px-6 py-4 text-right">
                                    <div class="flex items-center justify-end gap-2">
                                        ...
                                        <button
                                            onclick="confirmDelete('{{ route('admin.products.destroy', $product->id) }}', '{{ $product->name_en }}')"
