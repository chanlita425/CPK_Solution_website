            ...
            <table class="w-full">
                ...
                <tbody class="divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50 transition">
                        <td class="px-6 py-4">
                            @if($brand->logo_image)
                                <img src="{{ asset('storage/' . $brand->logo_image) }}" alt="{{ $brand->name_en }}" class="w-10 h-10 rounded-lg object-cover">
                            @else
                        ...
                        <td class="px-6 py-4 text-right">
                            <div class="flex items-center justify-end gap-2">
                                ...
                                <button onclick="confirmDelete('{{ route('admin.brands.destroy', $brand->id) }}', '{{ $brand->name_en }}')"
                    ...
                    <tr>
                        <td colspan="7" class="px-6 py-12 text-center text-gray-500">
                            ...
                            <a href="{{ route('admin.brands.create') }}" class="text-[#D7B259] hover:underline text-sm">Create your first brand →</a>
                        </td>
                    </tr>
                    @endforelse
                </tbody>
