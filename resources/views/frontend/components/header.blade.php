                ...
                <div class="hidden sm:flex items-center gap-1.5 sm:gap-2 mr-4">
                    @if ($settings->facebook_link)
                        <a href="{{ $settings->facebook_link }}"
                            class="w-6 h-6 sm:w-7 sm:h-7 flex items-center justify-center bg-white text-black rounded-full border border-gray-500 hover:bg-gray-100 transition-colors">
                            <i class="fa-brands fa-facebook-f text-xs sm:text-sm"></i>
                        </a>
                    @endif
                    @if ($settings->tiktok_link)
                        <a href="{{ $settings->tiktok_link }}"
                            class="w-6 h-6 sm:w-7 sm:h-7 flex items-center justify-center bg-white text-black rounded-full border border-gray-300 hover:bg-gray-100 transition-colors">
