...
<div class="rounded-[20px] bg-[#FAF6EE] flex flex-col items-center p-4 gap-2 hover:shadow-md transition-shadow">
    ...
    <a href="{{ url('/product/'.$product->id) }}" class="w-full flex items-center justify-center h-36 sm:h-40">
    ...
    <a href="{{ url('/product/'.$product->id) }}" 
       class="text-center text-xs font-bold text-black hover:text-yellow-600 transition leading-snug uppercase">
